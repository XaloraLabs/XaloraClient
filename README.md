...
- `git clone https://github.com/OpenXaloraClient/XaloraClient.git /var/www/xaloraclient`
...
`screen -S xaloraclient node index.js`</br>
To detach from the screen do ctrl + A + D</br>
To reattach `screen -R xaloraclient`</br>
To stop ctrl + C
